...
CGMZ.Versions["Achievements"] = "1.2.3";
...
CGMZ_Achievement_Window_Display.prototype.refresh = function() {
	...
	if(this.canShowCriteria(achievement)) {
		...
		y = this.drawCriteriaProgress(0, y, $gameSystem.battleCount(), req.battles, genericGaugeColor1, genericGaugeColor2, "戰鬥", achievement);
		y = this.drawCriteriaProgress(0, y, $gameSystem.winCount(), req.wins, genericGaugeColor1, genericGaugeColor2, "戰鬥勝利", achievement);
		y = this.drawCriteriaProgress(0, y, $gameSystem.escapeCount(), req.escapes, genericGaugeColor1, genericGaugeColor2, "逃跑成功", achievement);
		y = this.drawCriteriaProgress(0, y, $cgmz.countEarnedAchievements(), req.achievetotal, genericGaugeColor1, genericGaugeColor2, "成就", achievement);
		y = this.drawCriteriaProgress(0, y, $cgmz.countEarnedAchievementPoints(), req.achievepts, genericGaugeColor1, genericGaugeColor2, "成就點數", achievement);
