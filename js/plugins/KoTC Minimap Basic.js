 ...
 *
 *
 * @param Show Mode Hotkey
 * @desc For toggling show mode.
 * @default Q
 *
 *
 * @param Show Mode Note
 * @desc For toggling show note.
 * @default 'KoTC Minimap,KoTC QMinimap'
 *
 *
 */
...
function KoTCMinimapStart() {
    ...
    $KoTCMinimapSystem.PlayerFollowModeHotkey = $KoTCMinimapSystem.Parameters['Follow Mode Hotkey'];
    $KoTCMinimapSystem.ShowModeHotkey = $KoTCMinimapSystem.Parameters['Show Mode Hotkey'];
    // $KoTCMinimapSystem.ShowModeNote = $KoTCMinimapSystem.Parameters['Show Mode Note'].toString().split(',');
    $KoTCMinimapSystem.ShowModeNote = [
        new RegExp(/<KoTC Minimap: (\w+)\s?(\d+)?>/i), 
        new RegExp(/<KoTC QMinimap: (\w+)\s?(\d+)?>/i), 
        new RegExp(/<KoTC PMinimap: (\w+)\s?(\d+)?>/i)
    ]
    $KoTCMinimapSystem.ShowModeComment = [
        'KoTC Minimap', 
        'KoTC QMinimap', 
        'KoTC PMinimap', 
    ]
    $KoTCMinimapSystem.ShowModeName = [
        ' - 地圖', 
        ' - 任務', 
        ' - 寶物', 
    ]
    ...
    $KoTCMinimapSystem.ShowModeIndex = 0;
    $KoTCMinimapSystem.ShowMain = false;
    ...
    $KoTCMinimapSystem.BigMapHotkey = $KoTCMinimapSystem.Parameters['Big Map Hotkey'];
...
(function() {
    ...
    window.addEventListener('keydown', event => {
        ...
        // console.log('$KoTCMinimapSystem.BigMapHotkey : ', $KoTCMinimapSystem.BigMapHotkey)
        // console.log('$KoTCMinimapSystem.PlayerFollowModeHotkey : ', $KoTCMinimapSystem.PlayerFollowModeHotkey)
        // if (event.keyCode == $KoTCMinimapSystem.BigMapHotkey) {
        if (event.key == $KoTCMinimapSystem.BigMapHotkey && typeof KoTCMapDisabled == 'undefined') {
            AudioManager.playSe({name: "Equip3", pan: 0, pitch: 100, volume: 90}); 
            if ($KoTCMinimapSystem.BigMapOn == false) {
                ...
                $KoTCMinimapSystem.MapNameSprite = new Sprite(new Bitmap(640, $KoTCMinimapSystem.CurrentMinimapSize));
                $KoTCMinimapSystem.MapNameSprite.bitmap.fontSize = 20;
                $KoTCMinimapSystem.MapNameSprite.bitmap.fontBold = true;
                $KoTCMinimapSystem.MapNameSprite.bitmap.smooth = true;
                let displayName = $dataMap.displayName + $KoTCMinimapSystem.ShowModeName[$KoTCMinimapSystem.ShowModeIndex]
                $KoTCMinimapSystem.MapNameSprite.bitmap.drawText(displayName , 15, 15, 640, 20, 'left');
                SceneManager._scene.addChild($KoTCMinimapSystem.MapNameSprite);

                //$KoTCMinimapSystem.MapNameSprite = new Sprite(new Bitmap($KoTCMinimapSystem.SecondaryMinimapSprite.filterArea.width, $KoTCMinimapSystem.CurrentMinimapSize));
                //$KoTCMinimapSystem.MapNameSprite.bitmap.drawText($dataMap.displayName, 15, 15, $KoTCMinimapSystem.SecondaryMinimapSprite.filterArea.width, 20,'left');
                ...
                SceneManager._scene.removeChild($KoTCMinimapSystem.MapNameSprite);
        ...
        //     if ($KoTCMinimapSystem.BigMapOn == true) {
        //         $KoTCMinimapSystem.CurrentMinimapX = Number($KoTCMinimapSystem.DefaultXY[0]);
        //         $KoTCMinimapSystem.CurrentMinimapY = Number($KoTCMinimapSystem.DefaultXY[1]);
        //         $KoTCMinimapSystem.MainMinimapSprite.x = $KoTCMinimapSystem.CurrentMinimapX;
        //         $KoTCMinimapSystem.MainMinimapSprite.y = $KoTCMinimapSystem.CurrentMinimapY;
        ...
        if (event.key == $KoTCMinimapSystem.PlayerFollowModeHotkey) {
        ...
        if (event.key == $KoTCMinimapSystem.ShowModeHotkey) {
            $KoTCMinimapSystem.ShowModeIndex++;
            if($KoTCMinimapSystem.ShowModeIndex >= $KoTCMinimapSystem.ShowModeNote.length){
                $KoTCMinimapSystem.ShowModeIndex = 0
            }
            if($KoTCMinimapSystem.BigMapOn){
                SceneManager._scene.removeChild($KoTCMinimapSystem.MapNameSprite);
                $KoTCMinimapSystem.MapNameSprite = new Sprite(new Bitmap(640, $KoTCMinimapSystem.CurrentMinimapSize));
                $KoTCMinimapSystem.MapNameSprite.bitmap.fontSize = 20;
                $KoTCMinimapSystem.MapNameSprite.bitmap.fontBold = true;
        ...
        if (event.key == 'F9' && $gameTemp.isPlaytest()) {
            KoTCMinimapOff();
        }
        if (event.key == 'F3' && $gameTemp.isPlaytest()) {
            KoTCMinimapOn();
        }
    })
})();
...
KoTCMinimapEnable = function() {
    if ($gameMap && !$gamePlayer.isTransferring() && typeof KoTCMapDisabled == 'undefined') {
        ...
        if (Utils.RPGMAKER_NAME == "MZ") {
            ...
            var playerbitmap = ImageManager.loadPicture("../maps/Player", 0);
            $KoTCMinimapSystem.KoTCMinimapPlayerSprite = new Sprite(playerbitmap);
            $KoTCMinimapSystem.KoTCMinimapPlayerSprite.anchor.x = 0.5;
            $KoTCMinimapSystem.KoTCMinimapPlayerSprite.anchor.y = 0.5;
            $KoTCMinimapSystem.KoTCMinimapPlayerSprite.setColorTone($KoTCMinimapSystem.CurrentMinimapPlayerColor);
        ...
        // $KoTCMinimapSystem.MapNameSprite = new Sprite(new Bitmap(200, 200));
        // $KoTCMinimapSystem.MapNameSprite.bitmap.fontSize = 16;
        // $KoTCMinimapSystem.MapNameSprite.bitmap.drawText($dataMap.displayName, 15, 15, width, 20, 'left');
        // SceneManager._scene.addChild($KoTCMinimapSystem.MapNameSprite);
...
KoTCUpdateMinimapLocations = function() {
    if ($dataMap && !$gamePlayer.isTransferring() && SceneManager._scene instanceof Scene_Map) {
        ...
        if ($KoTCMinimapSystem.BigMapOn == false && $gamePlayer.screenX() > xmin && $gamePlayer.screenX() < xmax && $gamePlayer.screenY() > ymin && $gamePlayer.screenY() < ymax) {
            ...
            if ($KoTCMinimapSystem.BigMapOn) {
                $KoTCMinimapSystem.MainMinimapSprite.opacity = 200;
            } else {
                $KoTCMinimapSystem.MainMinimapSprite.opacity = 175;
            }
        }
        ...
        if ($gameMap && $gameMap.events() && SceneManager._scene instanceof Scene_Map) {
            var l = 0;
            for (; l < eventlength; l++) {
                var regexcode = new RegExp($KoTCMinimapSystem.ShowModeNote[$KoTCMinimapSystem.ShowModeIndex]);
                // var regexcode = new RegExp(/<KoTC Minimap: (\w+)\s?(\d+)?>/i);
                // if ($KoTCMinimapSystem.ShowMain) {
                //     regexcode = new RegExp(/<KoTC QMinimap: (\w+)\s?(\d+)?>/i);
                // }
                if (typeof $gameMap.events()[l] !== 'undefined' && typeof $dataMap.events[$gameMap.events()[l]._eventId] !== 'undefined') {
                    if (!$gameMap.events()[l]._erased) {
                        if ($gameMap.events()[l].page()) {
                            ...
                            var filterComment = $KoTCMinimapSystem.ShowModeComment[$KoTCMinimapSystem.ShowModeIndex];
                                if (pageindex.code === 108) {
                                    var comment = pageindex.parameters[0].split(' : ');
                                    // if (comment[0].includes("KoTC Minimap")) {
                                        if (comment[0].includes(filterComment)) {
                        ...
                        if (regexcode.exec($gameMap.events()[l].event().note) !== null || regexcode.exec($gameMap.events()[l].KoTCMapComment) !== null) {
                            if (RegExp.$2 !== "" && Math.round(Math.hypot($gamePlayer.x - $gameMap.events()[l].x, $gamePlayer.y - $gameMap.events()[l].y) <= RegExp.$2) || RegExp.$2 == "") {
                                ...
                                if (typeof $KoTCMinimapSystem.ArrayofMinimapPictureSprites[l] == 'undefined') {
                                    ...
                                    var ebitmap = ImageManager.loadPicture('../maps/' + RegExp.$1, 0);
...
function ConvertKeyNameToCode(key) {
    ...
    if (regexalphabet !== null && key.length == 1) {
        // console.log('key : ', key)
        // console.log('key.charCodeAt() : ', key.charCodeAt())
        // console.log('key.toLowerCase().charCodeAt() : ', key.toLowerCase().charCodeAt())
