//=============================================================================
// SoR_StoryObjectiveIndicator_MZ_Left.js
...
//=============================================================================
/*:ja
* @plugindesc ＜ストーリー目標インジケータ Type-L＞ v1.00
* @author 蒼竜
...
*/
/*:
* @plugindesc <Story Objective Indicator Type-L> v1.00
* @author Soryu
...
(function() {
	const pluginName = "SoR_StoryObjectiveIndicator_MZ_Left";
...
SoR_StoryObjIndicator.prototype.close = function() {
    ...
    this.windowcontrolx = this.width+9;
    this.isOpeningIndicator = false;
...
SoR_StoryObjIndicator.prototype.update = function() {
    ...
    if(Indicator_Style==0){//slide
            if(this.isOpeningIndicator){
                ...
                this.windowcontrolx = finX - this.x;
                if(this.windowcontrolx <= 0.0001){
                    this.x = 0;
                    this.isOpeningIndicator = false;
                ...
                this.x -= this.windowcontrolx/4;
                this.windowcontrolx = (this.width+9) +this.x;
                if(this.windowcontrolx <= 0.0001){
                    this.x = -this.width-9; 
                    this.isClosingIndicator = false;
                    this.resetIndicator();
