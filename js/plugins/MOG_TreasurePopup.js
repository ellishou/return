...
TreasureIcons.prototype.setupNew = function(data) {
	...
	this._amount = data[1];
	var name = this._item ? 
	Window_Base.prototype.convertEscapeCharacters(this._item.name.replace(new RegExp('§', "gi"), '')) + " x " + this._amount : this._amount;
...
TreasureIcons.prototype.refreshName = function() {
	...
	//return Temp_Window_Base.prototype.drawTextEx.call(this, name, 145,32)
};
